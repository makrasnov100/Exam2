...
private:
	...
	std::list<std::string>::iterator ticketOwner; // an iterator containing the party goer this ticket is associated with
...
public:
	...
	*/
	DinnerPartyTicket(Party *the_party, std::list<std::string>::iterator &ticketOwner) :
		the_party(the_party), ticketOwner(ticketOwner) {}
